...
export async function generateFacebookStyleReviews(count = 20, dateLimitDays = 60) {
  const urls = {
    firstNames:
      'https://ksiobbrextlywypdzaze.supabase.co/storage/v1/object/public/user-uploads/Fakereview/firstNames.csv',
    lastNames:
      'https://ksiobbrextlywypdzaze.supabase.co/storage/v1/object/public/user-uploads/Fakereview/lastNames.csv',
    comments:
      'https://ksiobbrextlywypdzaze.supabase.co/storage/v1/object/public/user-uploads/Fakereview/thaiComments.csv',
  };
