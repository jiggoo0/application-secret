...
async function getRandomPhoto(gender = 'male', cache = {}) {
  ...
  if (cachedFiles?.length) {
    ...
    return `${SUPABASE_URL}/storage/v1/object/public/user-uploads/Fakereview/${gender}/${file.name}`;
  }
  ...
  return `${SUPABASE_URL}/storage/v1/object/public/user-uploads/${folder}/${file.name}`;
}
...
export async function generateFacebookStyleReviews(count = 20, dateLimitDays = 60) {
  const urls = {
    firstNames: `${SUPABASE_URL}/storage/v1/object/public/user-uploads/Fakereview/firstNames.csv`,
    lastNames: `${SUPABASE_URL}/storage/v1/object/public/user-uploads/Fakereview/lastNames.csv`,
    comments: `${SUPABASE_URL}/storage/v1/object/public/user-uploads/Fakereview/thaiComments.csv`,
  };
