      ...
      <div className="bg-slate-950 p-10 text-white">
        <div className="mb-10 flex items-center justify-between border-b border-white/10 pb-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.4em]">Audit_Metrics</span>
          </div>
        ...
        <div className="space-y-10">
          ...
          <div>
            <div className="mb-3 flex justify-between text-[10px] font-black uppercase tracking-widest">
              ...
              <span
                className={cn(
                  stats.complexity_level === 'HIGH' || stats.complexity_level === 'CRITICAL'
                    ? 'text-red-500'
                    : 'text-[#FCDE09]',
                )}
              >
            ...
            <div className="h-1.5 w-full bg-white/5">
              <div
                className={cn(
                  ...
                  stats.complexity_level === 'HIGH' ? 'w-4/5 bg-red-600' : 'w-2/5 bg-[#FCDE09]',
                )}
              />
            </div>
          </div>
