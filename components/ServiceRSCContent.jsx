// components/ServiceRSCContent.js
// เป็น Server Component ธรรมดา (ไม่ใช่ Async Component)
...
/**
 * ServiceRSCContent: แสดงผลรายการบริการ
 * @param {Array} services - รายการข้อมูลบริการที่ถูกดึงมาแล้ว
 * @param {string} error - ข้อความแสดงข้อผิดพลาด
 */
const ServiceRSCContent = ({ services, error }) => {
  // Error UI
  if (error) {
    return (
...
export default ServiceRSCContent;
